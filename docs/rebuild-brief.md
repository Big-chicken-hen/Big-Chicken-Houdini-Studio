...
The [follow-up investigation](r4-help-followup-review.md) prioritizes WebEngine
path/exit logging and then the single known Launcher Qt PATH entry comparison.
The latter is prepared but unrun; `0xC0000135` is now observed in actual Studio
browser children, while the missing module and causal boundary remain unknown.
