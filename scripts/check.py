"""Focused static, backend, and native Qt checks (not a Houdini GUI test)."""
import argparse
import os
...
def main():
    ...
    parser.add_argument("--suite", choices=("all", "backend", "ui"), default="all",
                        help="UI files use the test_ui*.py prefix; backend never imports them")
