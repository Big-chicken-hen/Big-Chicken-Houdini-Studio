...
- Launcher and Panel follow the Pro UI brief and the user's explicit corrections. Use official assets or Qt standard icons only; no custom icons, brand marks or unsolicited controls. Do not add a legacy-context browser or profile-switching UI.
